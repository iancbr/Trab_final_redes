...
for qsize in 20 100; do
    ...
    # Executa o bufferbloat.py com flag de competição
    ...
    python3 plot_queue.py -f $dir/q.txt -o compete-buffer-q$qsize.png
    python3 plot_ping.py -f $dir/ping.txt -o compete-rtt-q$qsize.png
done
